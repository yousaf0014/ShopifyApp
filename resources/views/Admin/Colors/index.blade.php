                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                ...
                                <div class="col-xl-2">
                                    <a href="{{url('colorGroups/create')}}" class="btn btn-success btn-sm">
                                        <span class="icon text-white-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                                        </span>
                                        <span class="text">Add Color Group</span>
                                    </a>
                                </div>
                                <div class="col-xl-2">
                                    <a href="{{url('colorGroups/file')}}" class="btn btn-success btn-sm">
                                        <span class="icon text-white-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                                        </span>
                                ...
                                <div class="col-xl-2">
                                    <a href="{!! asset('colors.csv')!!}" class="btn btn-primary btn-sm">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover mb-4">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $counter = ($colors->currentPage()-1) * $colors->perPage();
                                                    ?>
                                                    @foreach ($colors as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url('/colorGroups/'.$row->id.'/')}}" title="View">
                                                                    <div class="icon-container">
                                                            ...
                                                            <td>
                                                                <a href="{{url('/colorGroups/'.$row->id.'/edit')}}" title="Edit Content" >
                                                                    <div class="icon-container">
                                                            ...
                                                            <td>
                                                                {!! Form::open(array('url' => '/colorGroups/' . $row->id ,'id'=>'deleted_'.$row->id,'class' => 'pull-right')) !!}
