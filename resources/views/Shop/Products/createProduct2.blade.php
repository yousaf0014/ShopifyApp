            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        {{ Html::ul($errors->all()) }}
                        {!! Form::open(array('url' => 'shopProductsStep3/'.$adminProduct->id,'id'=>'add_product','name'=>'add_product','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                            <div class="row">
                                                        ...
                                                        <?php foreach($group->attribute as $attr){ ?>
                                                            <div class="col-lg-12 form-group mb-4 mt-4">
                                                                ...
                                                                <div class="form-row mb-4">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        <label for="inputPassword4">Clip Art</label>
