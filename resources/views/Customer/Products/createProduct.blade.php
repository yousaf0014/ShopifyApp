            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        {{ Html::ul($errors->all()) }}
                        {!! Form::open(array('url' => 'storeProductsStep2/'.$adminProduct->id,'id'=>'add_product','name'=>'add_product','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                            <div class="row">
                                ...
                                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7">
                                    <div class="container">
                                        <div class="layout-px-spacing">
                                            ...
                                            <div class="col-lg-12 form-group mb-4">
                                                    <strong><label for="formGroupExampleInput" style="text-transform:capitalize;">User Stores</label></strong>
                                                    <select required name="stores[]" class="chosen-select form-control input-sm" multiple="multiple">
                                                        <option value="">--Slect Store--</option>
