                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                ...
                                <div class="col-xl-2">
                                    <a href="{{url('settings/create')}}" class="btn btn-success btn-sm">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover mb-4">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $counter = ($settings->currentPage()-1) * $settings->perPage();
                                                    ?>
                                                    @foreach ($settings as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url('/settings/'.$row->id.'/')}}" title="View">
                                                                    <div class="icon-container">
                                                            ...
                                                            <td>
                                                                <a href="{{url('/settings/'.$row->id.'/edit')}}" title="Edit Content" >
                                                                    <div class="icon-container">
