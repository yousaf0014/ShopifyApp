                                    ...
                                    <div class="tab-content" id="simpletabContent">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover mb-4">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <?php 
                                                                                $img = !empty($item->attributes[0]->mockup) ? $item->attributes[0]->mockup:'';?>

                                                                                <img src="{{$img}}" width="200px">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Status:<span style="text-transform:capitalize;">{{$item->status}}</span></td>
                                        ...
                                        <div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="profile-tab2">
                                            ...
                                            <?php foreach($items as $index=>$item){ ?>
                                                <?php $adminProduct = $adminProducts[$item->supplier_code]; ?>
                                                <div class="p-2 mt-4" style="border: 1px solid white">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered table-hover mb-4">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$adminProduct->supplier_code}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Product Price</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>Pic</td>
                                                                        <td><img src="url('/').'/../storage/app/public/uploads/'.$adminProduct->product_pic" width="200px"></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 layout-spacing">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered table-hover mb-4">
                                                                    <tr>
                                                                        <td>Sku</td>
                                                                        <td>{{$item->admin_supplier_code}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Title</td>
                                                                        <td>{{$item->name}}</td>
                                                                    ...
                                                                    <?php $attributes = json_decode($item->varient_list);
                                                                        foreach($attributes as $name=>$val1){
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                              <?php  if(strtolower($name) == 'code'){ ?>
                                                                                    <div class="boxColor" style="background: #{{$val1}}"></div>
                                                                                <?php } ?>
                                                                                    {{$val1}}
                                                                            </td>
                                                                        </tr>
                                                    ...
                                                    <div class="row">
                                                        <?php foreach($item->attributes as $itemImages){ ?>
                                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-3 layout-spacing">
                                                                <div class="widget widget-card-one">
                                                                    <div class="widget-content">
                                                                        <h6 class="ml-2 pt-2">{{$itemImages->side}}</h6>
                                                                        <div class="table-responsive">
                                                                            <table class="table table-bordered table-hover mb-4">
                                                                                <tr>
                                                                                    <td>Art Work</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: center;">
                                                                                        <?php
                                                                                        $img = '';
                                                                                        $img = $itemImages->design;
                                                                                        ?>
                                                                                        <img src="{{$img}}" width="200px">
                                                                                        <a class="btn btn-primary mt-3" href="{{$img}}" target="_blank">
                                                                                            Download
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: center;">
                                                                                        <?php $img1 = $itemImages->mockup;?>

                                                                                        <img src="{{$img1}}" width="200px">
                                                                                        <a class="btn btn-primary mt-3" href="{{$img1}}" target="_blank">
                                                                                            Download
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
