                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                ...
                                <div class="col-xl-2">
                                    <a href="{{url('addShopifyStore')}}" class="btn btn-success btn-sm">
                                        <span class="icon text-white-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                                        </span>
                                        <span class="text">Add Shopify Store</span>
                                    </a>
                                </div>
                                <div class="col-xl-2">
                                    <a href="{{url('stores/create')}}" class="btn btn-success btn-sm">
                                        ...
                                        <span class="text">Other Store</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover mb-4">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $counter = ($stores->currentPage()-1) * $stores->perPage();
                                                    ?>
                                                    @foreach ($stores as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url('/stores/'.$row->id.'/')}}" title="View">
                                                                    <div class="icon-container">
