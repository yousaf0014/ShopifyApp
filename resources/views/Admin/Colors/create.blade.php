            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        {{ Html::ul($errors->all()) }}
                        {!! Form::open(array('url' => 'colorGroups' ,'id'=>'add_group','name'=>'add_group','class'=>'form-horizontal')) !!}
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">Group</label>
                                <input type="text" name="name" value="<?php echo !empty($colorAttributeGroup)? $colorAttributeGroup->name:''; ?>" class="form-control input-sm" placeholder='Group Name' />
                            </div>
                            <div class="form-group mb-4">
                                <div class="row">
                                    ...
                                    <div id="options_data">
                                        <div class="row">
                                            <div class="col-lg-1 col-1 col-sm-1">&nbsp;</div>
                                            <div class="col-lg-5 col-5 col-sm-5">
                                                <input type="text" name="hash[1]" class="form-control input-sm">
                                            </div>
                                            <div class="col-lg-6 col-6 col-sm-6">
                                                <input type="text" name="color[1]" class="form-control input-sm">
                                            </div>
                                        </div>
                                    </div>
